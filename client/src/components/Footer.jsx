        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs opacity-70 mt-2">
              © {year} Lernitt Pty Ltd. All rights reserved.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <nav className="flex flex-col gap-2 text-xs">
              ...
              <Link to="/tutors" className="hover:underline">Find a tutor</Link>
          ...
          <div className="space-y-3">
            ...
            <nav className="flex flex-col gap-2 text-xs">
              <Link to="/signup?type=tutor" className="hover:underline">Apply to teach</Link>
              <Link to="/tutor" className="hover:underline">Tutor dashboard</Link>
              <Link to="/availability" className="hover:underline">Manage availability</Link>
              <Link to="/payouts" className="hover:underline">Payouts</Link>
            </nav>
          </div>
          ...
          <div className="space-y-3">
            ...
            <nav className="flex flex-col gap-2 text-xs">
              ...
              <Link to="/complaints" className="hover:underline">Complaints Policy</Link>
              <Link to="/age-requirements" className="hover:underline">Age Requirements</Link>
            </nav>
          </div>
        </div>
      </div>
