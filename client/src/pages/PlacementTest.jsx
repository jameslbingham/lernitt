...
export default function PlacementTest() {
  ...
  const submitTest = async () => {
    ...
    // Simulate complex AI analysis for believability
    setTimeout(() => {
    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4 dark:bg-slate-950">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-slate-800 dark:bg-slate-900">
          ...
          {/* STEP 1: ADAPTIVE GRAMMAR (Simplified Mockup) */}
          {step === 1 && (
            <div className="p-8 space-y-6">
              <h3 className="text-sm font-bold uppercase text-slate-400">Phase 1: Structural Integrity</h3>
              <p className="text-lg font-medium">"Had I known about the weather, I ________ my umbrella."</p>
          ...
          {step === 4 && (
            <div className="p-8 space-y-8 animate-in fade-in zoom-in duration-500">
              <div className="text-center">
                ...
                <div className="text-6xl font-black text-slate-900 dark:text-white mt-2">B2</div>
                <div className="text-lg font-bold text-slate-500 uppercase">Upper Intermediate</div>
              </div>

              <div className="rounded-xl border-l-4 border-indigo-500 bg-indigo-50 p-5 dark:bg-indigo-900/20">
                <h4 className="font-bold text-indigo-900 dark:text-indigo-300">Linguistic Gap Identified</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
                  Your fluency is high, but you have a **Grammar Gap** in 3rd Conditional structures 
                  that is preventing you from reaching C1.
                </p>
              </div>

              <div className="space-y-4">
                <h4 className="font-bold">Recommended Tutors for your level:</h4>
                <div className="flex items-center gap-4 rounded-xl border border-slate-100 p-4 shadow-sm">
                  <div className="h-12 w-12 rounded-full bg-slate-200" />
                  <div className="flex-1">
                    <div className="font-bold">Tutor Bob</div>
                    <div className="text-xs opacity-70">Expert in C1 Bridge Curriculum</div>
                  </div>
                  <button className="rounded-lg bg-indigo-600 px-3 py-1 text-xs font-bold text-white">Book Trial</button>
                </div>
              </div>
