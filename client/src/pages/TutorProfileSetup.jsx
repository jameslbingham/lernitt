...
export default function TutorProfileSetup() {
  ...
  // --- 🛠️ SURGICAL FIX: BYPASSING RLS POLICY VIOLATION ---
  async function handleFileUpload(e) {
    try {
      ...
      // 1. Generate a filename that avoids "Ownership" conflicts for new tutors
        ...
        <div style={{ 
          ...
          {payoutMethod === "paypal" && (
            <div style={{ marginTop: 16 }}>
              <label style={{ fontSize: 13, fontWeight: 600 }}>PayPal Email</label>
              <input 
                type="email" 
                value={paypalEmail} 
                ...
                style={{ width: "100%", padding: 12, borderRadius: 12, border: "1px solid #cbd5e1", marginTop: 4 }}
              />
            </div>
          )}
        </div>
